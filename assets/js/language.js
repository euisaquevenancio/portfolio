...
async function changeLanguage(language) {
    ...
    if (currentPath == "skill.html") {
        ...
        document.querySelector("#skills p:nth-child(1)").innerHTML = data.skill.paragraph;
        document.querySelector("#skills .skill:nth-child(2) b:nth-child(2)").innerHTML = data.skill.skill1.title;
        document.querySelector("#skills .skill:nth-child(2) p:nth-child(2)").innerHTML = data.skill.skill1.paragraph;
        document.querySelector("#skills .skill:nth-child(3) b:nth-child(2)").innerHTML = data.skill.skill2.title;
        document.querySelector("#skills .skill:nth-child(3) p:nth-child(2)").innerHTML = data.skill.skill2.paragraph;
        document.querySelector("#skills .skill:nth-child(4) b:nth-child(2)").innerHTML = data.skill.skill3.title;
        document.querySelector("#skills .skill:nth-child(4) p:nth-child(2)").innerHTML = data.skill.skill3.paragraph;
        document.querySelector("#skills .skill:nth-child(5) b:nth-child(2)").innerHTML = data.skill.skill4.title;
        document.querySelector("#skills .skill:nth-child(5) p:nth-child(2)").innerHTML = data.skill.skill4.paragraph;
        document.querySelector("#skills .skill:nth-child(6) b:nth-child(2)").innerHTML = data.skill.skill5.title;
        document.querySelector("#skills .skill:nth-child(6) p:nth-child(2)").innerHTML = data.skill.skill5.paragraph;
        document.querySelector("#skills .skill:nth-child(7) b:nth-child(2)").innerHTML = data.skill.skill6.title;
        document.querySelector("#skills .skill:nth-child(7) p:nth-child(2)").innerHTML = data.skill.skill6.paragraph;
    ...
    if (currentPath == "project.html") {
        ...
        document.querySelector("#portfolio p").textContent = data.project.portfolio.paragraph;
        document.querySelector("#portfolio img").src = "assets/img/mockup/portfolio-mockup-" + storagedTheme + "-" + language +".png";
        
        document.querySelector("#whoIsThatChampion p").textContent = data.project.witc.paragraph;
        document.querySelector("#whoIsThatChampion img").src = "assets/img/mockup/witc-mockup-" + storagedTheme + "-" + language +".png";

        document.querySelector("#whoIsThatChampionAPI p").textContent = data.project.witc.paragraph;
        document.querySelector("#whoIsThatChampionAPI img").src = "assets/img/mockup/witca-mockup-" + storagedTheme + "-" + language +".png";
        
        document.querySelector("#radarPraiaGrande p").textContent = data.project.radarpg.paragraph;
        if (language == "pt-br") {
        ...
        document.querySelector("#edusiga p").textContent = data.project.edusiga.paragraph;

        document.querySelector("#calculator h2").textContent = data.project.calculator.title;
        document.querySelector("#calculator p").textContent = data.project.calculator.paragraph;
        document.querySelector("#calculator img").src = "assets/img/mockup/calculator-mockup-" + storagedTheme + "-" + language +".png";

        document.querySelector("#fluxosul p").textContent = data.project.fluxosul.paragraph;
    ...
    if (currentPath == "contact.html") {
        document.querySelector(".container h1").textContent = data.contact.title;
        document.querySelector(".container p").textContent = data.contact.paragraph;

        document.querySelector(".container h3").textContent = data.contact.subtitle;
        document.querySelectorAll(".container .form-label")[0].textContent = data.contact.labelName;
        document.querySelectorAll(".container input")[0].placeholder = data.contact.inputNamePlaceholder;
        document.querySelector(".container #nameHelp").textContent = data.contact.nameHelp;
        document.querySelectorAll(".container .form-label")[1].textContent = data.contact.labelEmail;
        document.querySelectorAll(".container input")[1].placeholder = data.contact.inputEmailPlaceholder;
        document.querySelector(".container #emailHelp").textContent = data.contact.emailHelp;
        document.querySelectorAll(".container .form-label")[2].textContent = data.contact.labelMessage;
        document.querySelector(".container textarea").placeholder = data.contact.textareaMessagePlaceholder;
        document.querySelector(".container #messageHelp").textContent = data.contact.messageHelp;
        document.querySelector(".container .right button span").textContent = data.contact.formButton;
    }
}